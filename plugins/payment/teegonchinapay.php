...
class teegonchinapay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $param['return_url'] = return_url(basename(__FILE__, '.php'), false, array('type'=>0));
        $param['notify_url'] = return_url(basename(__FILE__, '.php'), true, array('type'=>1));//支付成功后天工支付网关通知
        ...
        $def_url  = '<br /><form style="text-align:center;" action="https://api.teegon.com/charge/pay" method="post" target="_blank">' .   // 不能省略
            ...
            "<input type='submit' value='" .立即付款. "' class='btn btn-info' style='width: 100%;background: #1cbb7f !important;
