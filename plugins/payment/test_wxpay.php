...
class wxpay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $button = '<div style="text-align:center"><button class="btn btn-info ect-btn-info ect-colorf ect-bg" style="background-color:#44b549;" type="button" onclick="javascript:if(confirm(\'订单商品为演示数据\n支付0.01元体验后不发货不退款\')){callpay()}">立即付款</button></div>' . $js;
